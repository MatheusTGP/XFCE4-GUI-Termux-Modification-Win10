...
start_install(){
	...
	echo -e "$C┎━─━─━──━──━─━─━─━──━─━──━─━──━─━─━─━─━──━─━──━─━─━──━─━─━┒"
        echo -e "$Y                      XFCWin Installer Lite"
        echo -e "           \033[04;38mThe Lite version installer from XFCWIN"
        echo -e "$W     $R Credits$W ⟩ MatheusTGamerPro"
        echo -e "$W     $R Version$W ⟩ v1.0-Lite $W"
	...
	apt install otter-browser audacious vim-gtk python-tkinter mtpaint aterm -y
